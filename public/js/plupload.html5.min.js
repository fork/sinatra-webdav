	...
	plupload.runtimes.Html5 = plupload.addRuntime("html5", {
		...
		init : function(uploader, callback) {
			...
			uploader.bind("Refresh", function(up) {
				...
				// webdav costomization start
				uploader.settings['url'] = $.cookie('webdav.' + up.settings.webdavContainer.attr('id') + '.href');
				// webdav costomization end
			...
			uploader.bind("UploadFile", function(up, file) {
				...
				function sendBinaryBlob(blob) {
					...
					function uploadNextChunk() {
						...
						// webdav costomization start (use POST again for now as PUT fails webdav test)
						full_url = up.settings.url.replace(/\*$/, '').replace(/#/, '') + file.name;
						xhr.open("post", plupload.buildUrl(full_url, args), true);
